...
class SwitchBtn(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.bgColorOn.setColorAt(0, QColor('#00EE76'))
        #self.bgColorOn.setColorAt(1, QColor('#ff7cbc'))

        self.bgColorOn.setColorAt(1, QColor('#6A5ACD'))
    ...
    def drawText(self, event, painter:QPainter):
        ...
        if self.checked:
            ...
            painter.drawText(self.space, 0, int(self.width() / 2 + self.space * 2), self.height(), Qt.AlignCenter,
                             self.textOn)
        else:
            painter.setPen(self.textColorOff)
            painter.drawText( int(self.width() / 2 - self.space * 2), 
                             0, 
    ...
    def drawSlider(self, event, painter):
        ...
        sliderRect = QRect(int(self.startX) + int(self.space), int(self.space), int(sliderWidth), int(sliderWidth))
